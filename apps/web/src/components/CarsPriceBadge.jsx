...
const CarsPriceBadge = ({ price, tier }) => {
  ...
  return (
    <div className="absolute top-3 right-3 z-20 bg-[#ff8c00] text-black px-3 py-1.5 rounded-md shadow-lg font-bold tracking-tight flex items-center gap-1.5 border border-[#ff8c00]/50 backdrop-blur-sm">
